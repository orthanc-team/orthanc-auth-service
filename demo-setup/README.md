...
- a nginx container that provides a web server on port 80.  It exposes the 2 Orthanc instances:
...
- 2 Orthanc containers, one configured for `admin` and one configured for `shares`
...
- create a public link by issuing this command:
```bash
